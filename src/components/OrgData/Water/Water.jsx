...
export const Water = ({ year, period, organizationId }) => {
      ...
      <div className='row'>
        <table className='table table-hover' id="my-table">
          <thead>
            ...
            <tr>
              <th className='btmTh'>куб.метр</th>
          ...
          <tbody>
            {reportData && reportData.water.map((item, index) => (
              <_Data key={`data-1123-${index}`}
                item={item}
              />
            ))}
          </tbody>
          <tfoot>
            {reportData &&
              <tr>
                <td>{reportData.waterTotalData.objectName}</td>
                <td>{reportData.waterTotalData.planValue}</td>
                <td>{reportData.waterTotalData.planSum}</td>
                <td>{reportData.waterTotalData.value}</td>
                <td>{reportData.waterTotalData.sum}</td>
                <td></td>
              </tr>
            }
          </tfoot>
