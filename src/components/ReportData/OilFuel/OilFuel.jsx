...
export const OilFuel = ({ startYear, startPeriod, startPeriodText, endYear, endPeriod, endPeriodText, organization }) => {
          ...
          <tbody>
            {reportData && reportData.dataView.map((item, index) => (
              <tr key={`data-123-${index}`}>
                ...
                {item.oilFuel.deviation.result ? <td className={style["up"]}></td> : <td className={style["down"]}></td>}
                <td className={style["bold"]}>{item.oilFuel.consumption1M2}</td>
              </tr>
            ))}
          </tbody>
          <tfoot>
            {reportData &&
              <tr>
                ...
                {reportData.totalData.oilFuel.deviation.result ? <td className={style["up"]}></td> : <td className={style["down"]}></td>}
                <td>{reportData.totalData.oilFuel.consumption1M2}</td>
              </tr>
            }
          </tfoot>
        </table>
